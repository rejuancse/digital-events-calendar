...
class Calendar_Shortcode { 
    ...
    private function _createNavi(){         
        ...
        return '<div class="head-area">
                    ...
                    <div class="btn-area flex">
                        <a class="btn event-btn prev" id="premonth" month='.sprintf("%02d", $preMonth).' year='.$preYear.' onclick="getPrevMonth();">
                                <i class="fa fa-angle-left"></i></a>

                        <a class="btn next" id="nextmonth" month='.sprintf("%02d", $nextMonth).' year='.$nextYear.' onclick="getNextMonth()"><i class="fa fa-angle-right"></i></a>
                    </div>
                </div>';
    }
    ...
    * --------------------------------- */ 
    public function showCalender( $nextmonth, $nextyear ) {
...
<script type="text/javascript">
    ...
    function getNextMonth(){
        ...
        jQuery.ajax({
            ...
            data: { "action": "edisplaynextmonth", "nextmonth":nextmonth, "nextyear":nextyear, _nonce : eajax_objects.ajax_nonce },

    ...
    private function _createNavi(){
        ...
        return '<div class="head-area">
                    ...
                    <div class="btn-area flex">
                        <a class="btn event-btn prev" id="premonth" month='.sprintf("%02d", $preMonth).' year='.$preYear.' onclick="getPrevMonth();">&#10094;</a>
                        <a class="btn next" id="nextmonth" month='.sprintf("%02d", $nextMonth).' year='.$nextYear.' onclick="getNextMonth()">&#10095;</a>
                    </div>
                </div>';
    }
